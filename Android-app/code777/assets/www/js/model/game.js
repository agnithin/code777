...
/** Creates an model for Game
    ...
    @property {Boolean} gameMode if the game is single player or multiplayer
*/
function Game(_gameMode, _playerId){
	this.deck = new Deck();
...
Game.prototype.answerNextQuestion = function(){
	...
	var aQuestion = this.answerQuestion(this.questionOrder[this.answeredQuestion.length % 23]);
