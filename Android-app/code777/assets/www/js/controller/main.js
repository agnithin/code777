...
//});
	...
	function gameInit(){
		...
		//create new board for rough guessing
		...
		//create list of answers answered by players
	...
	function checkGuess(){
		...
		var isGuessCorrect = game.checkGuess(cardOneNumber.value, cardOneColor.value, 
										cardTwoNumber.value, cardTwoColor.value, 
										cardThreeNumber.value, cardThreeColor.value)
	...
	/**
	 * create a form for guessing the numbers
	 */
